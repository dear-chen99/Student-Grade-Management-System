...
class LoginWindow(ctk.CTk):
    def __init__(self):
        ...
        self.username_entry = ctk.CTkEntry(self.card, placeholder_text="请输入用户名", height=40, corner_radius=10)
        self.username_entry.pack(pady=10, padx=25, fill="x")

        self.password_entry = ctk.CTkEntry(self.card, placeholder_text="请输入密码", height=40, corner_radius=10, show="*")
    ...
    def _prepare_and_show(self):
        ...
        text_x = w // 3.5
        text_y = h // 2
        self.canvas.create_text(text_x, text_y - 50, text="学生成绩管理系统", font=("微软雅黑", 26, "bold"), fill="white")
        self.canvas.create_text(text_x, text_y + 10, text="登录以管理你的班级、成绩与数据", font=("微软雅黑", 12), fill="#EBEBEB")
